...
public class TernaryOperatorExpression extends LeafExpression {
	...
	public TernaryOperatorExpression(
			...
			@JsonProperty("condition")AbstractExpression condition,
			@JsonProperty("thenExpression")AbstractExpression thenExpression,
			@JsonProperty("elseExpression")AbstractCodeFragment elseExpression
	) {
