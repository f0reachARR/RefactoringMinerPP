...
public class InlineVariableRefactoring implements Refactoring, ReferenceBasedRefactoring, LeafMappingProvider {
	...
	public void addUnmatchedStatementReferences(Set<AbstractCodeFragment> fragmentsT2) {
	...
	public RefactoringScope getRefactoringScope() {
		...
		references.forEach(t -> scope.addAffectedLocation(t.getFragment2().getLocationInfo()));
