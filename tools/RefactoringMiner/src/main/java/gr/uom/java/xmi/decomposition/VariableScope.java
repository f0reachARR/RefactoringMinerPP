...
public class VariableScope {
	...
	public VariableScope(
			...
			@JsonProperty("statementsInScopeUsingVariable")Set<Integer> statementsInScopeUsingVariable
	) {
		this.filePath = filePath;
		this.startOffset = startOffset;
		this.endOffset = endOffset;
		...
		statementsInScopeUsingVariable.forEach(t -> this.statementsInScopeUsingVariable.add(AbstractCodeFragment.get(t)));
	}
}
