...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public VariableDeclaration(
			...
			@JsonProperty("initializer")AbstractExpression initializer,
			@JsonProperty("type")UMLType type,
			@JsonProperty("locationInfo")LocationInfo locationInfo,
			@JsonProperty("isParameter")boolean isParameter,
			@JsonProperty("isAttribute")boolean isAttribute,
			@JsonProperty("isEnumConstant")boolean isEnumConstant,
