...
public class LocationInfo {
	...
	public LocationInfo(
			...
			@JsonProperty("codeElementType")CodeElementType codeElementType
	) {
		this.filePath = filePath;
	...
	public LocationInfo copy() {
		return new LocationInfo(filePath, startOffset, endOffset, length, startLine, startColumn, endLine, endColumn, codeElementType);
	}

	public void reduceToFirstLine() {
