...
public class UMLParameterDiff {
	...
	public Set<Refactoring> getRefactorings() {
		...
		List<UMLModifier> addedModifiers = UMLModifierListDiff.getAddedModifiers(originalVariable.getModifiers(), newVariable.getModifiers());

		for (UMLModifier m : addedModifiers) {
			refactorings.add(new AddVariableModifierRefactoring(m, originalVariable, newVariable, removedOperation, addedOperation, false));
		}

		List<UMLModifier> removedModifiers = UMLModifierListDiff.getRemovedModifiers(originalVariable.getModifiers(), newVariable.getModifiers());

		for (UMLModifier m : removedModifiers) {
			refactorings.add(new RemoveVariableModifierRefactoring(m, originalVariable, newVariable, removedOperation, addedOperation, false));
		}
