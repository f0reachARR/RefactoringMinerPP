...
public class LeafType extends UMLType implements Cloneable {
	...
	public LeafType(
			...
			@JsonProperty("arrayDimension")int arrayDimension,
			@JsonProperty("parameterized")boolean parameterized,
			@JsonProperty("typeArguments")List<UMLType> typeArguments,
			@JsonProperty("classType")String classType,
			@JsonProperty("nonQualifiedClassType")String nonQualifiedClassType
	) {
		super(locationInfo, arrayDimension, parameterized, typeArguments);

		this.classType = classType;
		this.nonQualifiedClassType = nonQualifiedClassType;
	}
}
