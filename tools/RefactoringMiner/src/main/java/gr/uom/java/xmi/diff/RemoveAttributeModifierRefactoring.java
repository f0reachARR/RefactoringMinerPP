...
public class RemoveAttributeModifierRefactoring implements Refactoring {
	...
	public RemoveAttributeModifierRefactoring(UMLModifier modifier, UMLAttribute attributeBefore, UMLAttribute attributeAfter) {
		this(modifier.getKeyword(), attributeBefore, attributeAfter);
