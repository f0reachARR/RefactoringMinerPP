...
@JsonSubTypes({
		@JsonSubTypes.Type(value = AbstractCall.class, name = "AbstractCall"),
		@JsonSubTypes.Type(value = TernaryOperatorExpression.class, name = "TernaryOperatorExpression"),
		@JsonSubTypes.Type(value = LeafExpression.class, name = "LeafExpression")
})
