...
public class RemoveVariableModifierRefactoring implements Refactoring {
	...
	private UMLModifier removedModifier;
	...
	public RemoveVariableModifierRefactoring(UMLModifier modifier, VariableDeclaration variableBefore,
											 VariableDeclaration variableAfter, VariableDeclarationContainer operationBefore, VariableDeclarationContainer operationAfter,
											 boolean insideExtractedOrInlinedMethod) {
		this(modifier.getKeyword(), variableBefore, variableAfter, operationBefore, operationAfter, insideExtractedOrInlinedMethod);

		this.removedModifier = modifier;
	}
	...
	public RefactoringScope getRefactoringScope() {
		return new RefactoringScope().addAffectedLocation(getRemovedModifier().getLocationInfo());
	}
}
