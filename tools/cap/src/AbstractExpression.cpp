...
AbstractExpression::AbstractExpression(std::string expression, LocationInfo* location_info,
                                       CompositeStatementObject* owner, int depth, int index)
...
{
  is_converted_ = false;
  lambda_owner_ = nullptr;
}

AbstractExpression::~AbstractExpression()
{
  delete lambda_owner_;
